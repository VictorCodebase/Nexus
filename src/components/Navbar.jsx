      ...
      <div className="flex space-x-5">
        ...
        {isAuthenticated ? (
          <div className="relative" ref={dropdownRef}>
            <button onClick={toggleDropdown} className="flex items-center space-x-2 hover:text-gray-300">
              <CircleUser size={24} />
            </button>
            ...
            {showDropdown && (
              <div className="absolute right-0 mt-2 w-40 bg-white text-black shadow-md rounded-lg border">
                ...
                <button className="flex w-full items-center gap-2 px-4 py-2 text-red-500 hover:bg-gray-100">
                  <LogOut size={16} />
                  Logout
                </button>
              </div>
